...
class ScheduleController
{
  ...
  List<ScheduleListModel> getTempleList()
  {
      List<ScheduleListModel> scheduleList = [
        ScheduleListModel(imageText: "Temple 1", imageUrl:"assets/images/temple1.jpeg", name: "Kesi Ghat",time : "time", description: "description"),
        ScheduleListModel(imageText:"Temple 2",imageUrl: "assets/images/temple3.jpg", name:"Madan Mohan",time :"time",description:"description"),
